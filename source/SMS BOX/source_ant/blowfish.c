...
rom static const unsigned long ORIG_P[N + 2] = 
{
...
rom static const unsigned long ORIG_S[4][256] = 
{
  {   
...
static DWORD F(/*BLOWFISH_CTX *ctx,*/ DWORD x) 
{
  BYTE a, b, c, d;
  DWORD  y;
  DWORD tmp;
  ...
  memcpypgm2ram( (void*)&tmp, (const rom void*)&ORIG_S[0][a], sizeof( DWORD ));
  y = tmp;

  memcpypgm2ram( (void*)&tmp, (const rom void*)&ORIG_S[1][b], sizeof( DWORD ));
  y += tmp;
  
  memcpypgm2ram( (void*)&tmp, (const rom void*)&ORIG_S[2][c], sizeof( DWORD ));
  y ^= tmp;

  memcpypgm2ram( (void*)&tmp, (const rom void*)&ORIG_S[3][c], sizeof( DWORD ));
  y += tmp;
...
void Blowfish_Encrypt( DWORD *xl, DWORD *xr )
{
  ...
  //DWORD dwArray[N + 2];
  //memcpypgm2ram( (void*)dwArray, (const rom void*)ORIG_P, sizeof( ORIG_P ));
