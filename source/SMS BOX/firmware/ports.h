...
#elif ( BOARD_VERSION == 0x02000000 )
    #define GSM_PWRKEY            LATCbits.LATC0
    #define GSM_PWRKEY_DIR        TRISCbits.TRISC0
    #define GSM_STATUS            PORTCbits.RC5
    #define GSM_STATUS_DIR        TRISCbits.TRISC5
#endif
...
// SIMs Cards
  ...
  #define SIM_SEL_03           LATAbits.LATA3
  #define SIM_SEL_03_DIR       TRISAbits.TRISA3
  #define SIM_SEL_EN           LATBbits.LATB2
  #define SIM_SEL_EN_DIR       TRISBbits.TRISB2
#else
